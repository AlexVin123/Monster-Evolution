...
namespace Supercyan.FreeSample
{
    public class SimpleSampleCharacterControl : MonoBehaviour
    {
        ...
        private void TankUpdate()
        {
            ...
            m_rigidBody.position += transform.forward * m_currentV * m_moveSpeed * Time.deltaTime;
            m_rigidBody.rotation *= Quaternion.Euler(0, m_currentH * m_turnSpeed * Time.deltaTime, 0);
